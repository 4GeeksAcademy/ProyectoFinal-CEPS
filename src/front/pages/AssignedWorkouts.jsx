            ...
            <div className="list-group">
              {assignedRoutines.map((assigned) => (
                <div key={assigned.id} className="list-group-item">
                  <h5 className="mb-0">{assigned.routine?.name}</h5>
                  <p className="mt-2 mb-1">{assigned.routine?.description}</p>
          ...
          {assignedClasses.length === 0 ? (
            ...
            <div className="list-group">
              {assignedClasses.map((assigned) => (
                <div key={assigned.id} className="list-group-item">
                  <h5 className="mb-0">{assigned.class?.title}</h5>
                  <p className="mt-2 mb-1">{assigned.class?.description}</p>
                  <small className="text-muted">
                    Asignado por: {assigned.trainer_name} | Fecha: {assigned.assigned_date}
                  </small>
                  <br />
